...
def main():
    ...
    while True:
        ...
        if int(choice) == 1:
            School_Students.create_student()
        elif int(choice) == 2:
            School_Students.read_student()
        elif int(choice) == 3:
            School_Students.update_student()
        elif int(choice) == 4:
            School_Students.delete_student()
        elif int(choice) == 5:
            School_Teachers.create_teacher()
        elif int(choice) == 6:
            School_Teachers.read_teacher()
        elif int(choice) == 7:
            School_Teachers.update_teacher()
        elif int(choice) == 8:
            School_Teachers.delete_teacher()
        else:
            break
...
def search_student_by_surname(eponymo):
    students = load_students_data()
    id_list = []b   
    for i in range(len(students)):b   
        if students[i]["surname"] == eponymo:b   
            id_list.append(students[i]["studentid"])b   
    b   
    return id_list
